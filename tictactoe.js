...
function placeXOrO(squareNumber) {
	...
	if (!selectedSquares.some(element => element.includes(squareNumber))) {
		// This variable retrieves HTML element id that was clickd.
		...
		checkWinConditions();
		// This condition is for changinf the active player.
		if (activePlayer === 'X') {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
	...
	y1 = coordY1, 
	// This line indicates where the end of a lines a axis is.
	x2 = coordsX2,
	...
	function animateLineDrawing() {
		...
		if (x1 <= x2 && y1 <= y2) {
			// This conditions adds 10 to the previous end x endpoint.
			if (x < x2) { x +=10;}
...
animateLineDrawing();
// This line waits i second. Then, clears canvas, resets game and allows clicking again.
